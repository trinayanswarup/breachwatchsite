      ...
      <main className="flex-1">
        ...
        <section className="bg-gradient-to-b from-blue-50 to-white px-4 pt-10 pb-8">
          <div className="mx-auto max-w-3xl">
            <nav aria-label="Breadcrumb" className="mb-4 flex items-center gap-1.5 text-sm text-gray-500">
              ...
              <span aria-hidden="true">›</span>
              <span className="text-gray-900">Bitwarden vs 1Password</span>
            </nav>
            ...
            <p className="mt-4 text-lg text-gray-600">
              Bitwarden scores <strong className="text-gray-900">9.4/10</strong>;
              1Password scores <strong className="text-gray-900">7.0/10</strong>. The
        ...
        <article className="mx-auto max-w-3xl px-4 pb-4">
          ...
          <section className="mb-10">
            ...
            <p className="mb-3 text-gray-700">
              <strong className="text-gray-900">Choose Bitwarden if:</strong> you want
            ...
            <p className="text-gray-700">
              <strong className="text-gray-900">Choose 1Password if:</strong> you want
