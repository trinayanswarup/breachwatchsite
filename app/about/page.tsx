    ...
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1">
        ...
        <article className="mx-auto max-w-3xl px-4 py-10 space-y-12">
          ...
          <section>
            <h2 className="mb-4 text-2xl font-bold text-gray-900">Why we exist</h2>
            ...
            <p className="text-gray-700">
              ...
              <Link href="/disclosure" className="text-blue-600 underline hover:text-blue-800">
                disclosure page
              </Link>
              .
            </p>
          ...
          <section>
            <h2 className="mb-4 text-2xl font-bold text-gray-900">Our scoring methodology</h2>
            ...
            {CATEGORIES.map(({ key, label, href }) => (
              <div key={key} className="mb-8">
                <div className="mb-3 flex items-baseline justify-between">
                  <h3 className="text-lg font-bold text-gray-900">{label} criteria</h3>
                ...
                <div className="space-y-2">
                  {allCriteria[key].map((c) => (
                    <div key={c.id} className="flex items-start gap-3 rounded-lg border border-gray-100 bg-gray-50 px-4 py-3">
                      <span className="mt-0.5 shrink-0 rounded-full bg-blue-100 px-2 py-0.5 text-xs font-bold text-blue-700">
                        {c.weight}%
                      </span>
                      <div>
          ...
          <section>
            <h2 className="mb-4 text-2xl font-bold text-gray-900">Our business model</h2>
            <p className="mb-3 text-gray-700">
          ...
          <section>
            <h2 className="mb-4 text-2xl font-bold text-gray-900">What we do not do</h2>
