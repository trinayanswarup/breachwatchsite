...
const SCORE_COPY: Record<number, ScoreCopy> = {
  1: {
...
export function generateStaticParams() {
  return [1, 2, 3, 4, 5].map((score) => ({ score: String(score) }));
}
    ...
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex flex-1 flex-col items-center justify-center px-4 py-16 text-center">
        <div className="mx-auto w-full max-w-md">
          <div
            className={`inline-flex flex-col items-center rounded-[3px] border-2 px-10 py-6 ${copy.colorClass}`}
          >
          ...
          <h1 className="mt-6 text-2xl font-bold text-bw-black">
            {copy.headline}
          </h1>
