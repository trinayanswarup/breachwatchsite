    ...
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1">
        ...
        <article className="mx-auto max-w-3xl px-4 py-10 space-y-10">
          ...
          <section>
            <h2 className="mb-4 text-xl font-bold text-gray-900">What data we collect</h2>
          ...
          <section>
            <h2 className="mb-4 text-xl font-bold text-gray-900">Custom analytics events</h2>
            <p className="mb-3 text-gray-700">
              We track the following custom events via Vercel Analytics to understand
              how readers use the site:
            </p>
            <ul className="space-y-2 rounded-lg border border-gray-200 bg-gray-50 px-5 py-4 text-sm text-gray-700">
              {[
                ...
                <li key={event} className="flex items-start gap-3">
                  <code className="mt-0.5 shrink-0 rounded bg-gray-200 px-1.5 py-0.5 text-xs font-mono text-gray-800">
                    {event}
                  </code>
                  <span>{desc}</span>
                </li>
          ...
          <section>
            <h2 className="mb-4 text-xl font-bold text-gray-900">The security quiz</h2>
            <p className="mb-3 text-gray-700">
          ...
          <section>
            <h2 className="mb-4 text-xl font-bold text-gray-900">Affiliate links</h2>
            <p className="mb-3 text-gray-700">
          ...
          <section>
            <h2 className="mb-4 text-xl font-bold text-gray-900">Cookies</h2>
            <p className="text-gray-700">
          ...
          <section>
            <h2 className="mb-4 text-xl font-bold text-gray-900">Third-party services</h2>
          ...
          <section>
            ...
            <p className="text-gray-700">
              ...
              <a href="mailto:privacy@breachwatchsite.com" className="text-blue-600 underline hover:text-blue-800">
